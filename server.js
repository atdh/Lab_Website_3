...
app.get('/team_stats', function(req, res) {
	...
	var winner = 'select count(*) as col from football_games where home_score > visitor_score;';
	var losers = 'select count(*) as col from football_games where home_score < visitor_score;';
...
app.get('/player_info/post', function(req, res) {
  ...
  var games = 'select count(*) as games from football_games where players @> ARRAY[' + req.query.player_choice + '];'
